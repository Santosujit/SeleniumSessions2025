...
public class WaitForElements {
    ...
    public static void main(String[] args) {
        ...
        // The below wait waits for all the footer links to be visible on the web page
        // All the footer Links re captured in the footers By Locator

        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));

        List<WebElement> footerList = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(footers));
        // An expectation for checking that all elements present/visible on the web page that
