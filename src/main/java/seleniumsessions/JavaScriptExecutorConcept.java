...
//		JavascriptExecutor is used to run javascript using selenium, we use executeScript method

		JavascriptExecutor js = (JavascriptExecutor) driver;
//		String title = js.executeScript("return document.title").toString();//toString is used to convert to java object
...
//		String pageText = js.executeScript("return document.documentElement.innerText;").toString();//It'll give you the entire webpage's tect
