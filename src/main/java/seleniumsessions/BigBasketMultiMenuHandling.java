...
public class BigBasketMultiMenuHandling {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		By level1 = By.xpath("(//span[text()='Shop by'])[2]");// this is a UI Bug in Bigbasket
	...
	public static void ParentChildMenu(By level1, By level2, By level3, By level4) throws InterruptedException {
		...
		act.moveToElement(getElement(level2)).perform();// mouse over
		Thread.sleep(1000);
		act.moveToElement(getElement(level3)).perform();// mouse over
		Thread.sleep(1000);
